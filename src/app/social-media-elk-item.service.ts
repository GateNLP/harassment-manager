...
//todo: potentially does not need separate service from original
@Injectable({ providedIn: 'root' })
export class SocialMediaElkItemService {
  ...
  constructor(
    ...
    this.twitterElkApiService.onTweetsLoaded.subscribe(count => {
  ...
  fetchItems(
    ...
    const result = this.fetchTweets(startDateTimeMs, endDateTimeMs, ids).pipe(
